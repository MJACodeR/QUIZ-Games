...
def saveChanges(dataList):
    with open('C:\\Users\Abhishek chaurasiya\\PycharmProjects\\Quiz Games\\Q-A-Python-Game-GUI-master\\data.txt', 'w') as outfile:
...
while True:
    ...
    try:
        ...
        if choice == 'a':
            ...
            question = str(inputSomething(
                "Enter the question: ").strip()).lower()
            while True:
                if(question == ""):
                    question = str(inputSomething(
                        "Enter the question: ").strip()).lower()
            ...
            while True:
                x = str(
                    input("Enter a valid answer (enter 'q' when done):").strip()).lower()
                if(x == ''):
                    continue
                elif(x != '' and x != 'q'):
                    answer.append(x)
            ...
            final_object = {'question': question,
                            'answer': answer, 'diff_level': diff}
